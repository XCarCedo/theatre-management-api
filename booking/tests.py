...
class BookingTests(APITestCase):
    def setUp(self):
        ...
        self.theatre1 = self._create_theatre_via_api(self.manager, "t1", 3, "5.00")
        self.theatre2 = self._create_theatre_via_api(self.manager, "t2", 2, "5.00")
        self.theatre3 = self._create_theatre_via_api(self.manager, "t3", 1, "5.00")
    ...
    def test_create_theatres(self):
        error_theatre = self._create_theatre_via_api(self.customer, "error", 5, "5.00")
    ...
    def test_theatre_detail_update(self):
        ...
        response_valid = self.client.patch(
            reverse("theatre_detail", kwargs={"pk": self.theatre1.json()["id"]}),
            {"seats_count": 5},
        )
